...
// Source: internal/store/s3_bucket_store.go
//
// Generated by this command:
//
//	mockgen -source=internal/store/s3_bucket_store.go -destination=internal/store/mocks/mock_s3_bucket_store.go -package=mocks
//
